...
<x-layout>
    ...
    <div class="relative">
        <div x-data="{ slide: 0, totalSlides: 3 }" x-init="startSlideTimer">
            <div class="overflow-hidden" style="height: 500px; display: flex; align-items: center;"> <!-- Sesuaikan tinggi gambar di sini -->
                <div class="flex transition-transform duration-1000 ease-in-out" :style="'transform: translateX(-' + slide * 100 + '%)'">
                    <div class="w-full flex-shrink-0">
                        <img src="img/image1.jpg" alt="Slide 1" class="w-full h-full"> <!-- Gunakan w-full dan h-full untuk memastikan gambar tetap sesuai dengan tinggi container -->
                    </div>
                    <div class="w-full flex-shrink-0">
    ...
    <div class="mt-10">
        <h1 class="text-center text-4xl font-bold text text-green-700 ">BUKU <span class="font-medium text-blue-900">TERBARU</span> </h1>
        <div class="border mt-4 border-green-700"></div>
        <div class="mt-8 grid gap-1 md:grid-cols-3">
